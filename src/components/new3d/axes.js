...
const Axes = ({ focus, alpha, rcu }) => {
    ...
    return (
        <g>
            <line strokeDasharray="5, 5" x1={focus[0]} y1={focus[1]} x2={focus[0] + rcu.r} y2={focus[1]} style={{ ...lineStyle, strokeWidth: 1 }} />
            ...
            <line strokeDasharray="5, 5" x1={focus[0]} y1={focus[1]} x2={focus[0]} y2={focus[1] - rcu.c} style={{ ...lineStyle, strokeWidth: 1 }} />
            ...
            <line strokeDasharray="5, 5" x1={focus[0]} y1={focus[1]} x2={focus[0] + depthX} y2={focus[1] - depthY} style={{ ...lineStyle, strokeWidth: 1 }} />
